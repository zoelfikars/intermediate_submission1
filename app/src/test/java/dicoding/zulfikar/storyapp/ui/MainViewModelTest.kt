package dicoding.zulfikar.storyapp.ui
...
import dicoding.zulfikar.storyapp.DataDummy
import dicoding.zulfikar.storyapp.MainDispatcherRule
...
import dicoding.zulfikar.storyapp.getOrAwaitValue
import dicoding.zulfikar.storyapp.view.MainViewModel
import dicoding.zulfikar.storyapp.view.main.StoryPagingAdapter
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStoryPaging(token)).thenReturn(expectedStory)

        val viewModel = MainViewModel(storyRepository)
        val actualStory: PagingData<ListStoryItem> =
            viewModel.getStoryPaging(token).getOrAwaitValue()
